  ...
  create  table "db_warehouse"."public_analytics"."fct_transactions__dbt_tmp"
...
WITH enriched AS (SELECT * FROM "db_warehouse"."public_intermediate"."int_transactions_enriched"),
